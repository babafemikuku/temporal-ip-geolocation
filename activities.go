...
// Now we have created our two activities.
// Now, we'd coordinate them using a Temporal Workflow
//
// Activities don't have the same determinism constraints that Workflows have
